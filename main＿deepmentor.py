...
READ_PDF_TASK= 'You are a helpful agent need to follow the steps below,click the aaron block'
...
async def run_login_automation():
    ...
    try:
        ...
        browser = Browser(BrowserConfig(chrome_instance_path="/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"))
